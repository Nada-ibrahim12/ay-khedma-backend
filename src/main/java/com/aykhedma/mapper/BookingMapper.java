...
public interface BookingMapper
{
    ...
    @Mapping(source = "consumerRating", target = "consumerRating")
    @Mapping(target = "consumerReview", expression = "java(booking.getConsumerReview() != null && !booking.getConsumerReview().trim().isEmpty() ? booking.getConsumerReview() : null)")
    @Mapping(source = "providerRating", target = "providerRating")
    @Mapping(target = "providerReview", expression = "java(booking.getProviderReview() != null && !booking.getProviderReview().trim().isEmpty() ? booking.getProviderReview() : null)")
