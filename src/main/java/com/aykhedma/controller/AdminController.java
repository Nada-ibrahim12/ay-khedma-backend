...
public class AdminController {
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "List of pending providers retrieved successfully",
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Provider details retrieved successfully",
                content = @Content(schema = @Schema(implementation = ProviderResponse.class))),
        @ApiResponse(responseCode = "403", description = "Unauthorized - admin access required"),
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Provider approved successfully",
                content = @Content(schema = @Schema(implementation = ProviderResponse.class))),
        @ApiResponse(responseCode = "403", description = "Unauthorized - admin access required"),
        @ApiResponse(responseCode = "404", description = "Provider not found"),
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Provider rejected successfully",
                content = @Content(schema = @Schema(implementation = ProviderResponse.class))),
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Providers found successfully",
                content = @Content(schema = @Schema(implementation = ProviderResponse.class))),
