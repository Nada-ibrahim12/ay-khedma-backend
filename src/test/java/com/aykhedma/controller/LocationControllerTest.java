...
class LocationControllerTest {
        ...
        void saveConsumerLocation_ShouldReturnCreated() throws Exception {
                ...
                mockMvc.perform(post("/api/v1/locations/consumer/me")
        ...
        void updateConsumerLocation_ShouldReturnOk() throws Exception {
                ...
                mockMvc.perform(put("/api/v1/locations/consumer/me")
                                .with(authenticatedConsumer())
                                .contentType(MediaType.APPLICATION_JSON)
                                .content(objectMapper.writeValueAsString(locationDTO)))
        ...
        void patchConsumerLocation_ShouldReturnOk() throws Exception {
                ...
                mockMvc.perform(patch("/api/v1/locations/consumers/me")
                                .with(authenticatedConsumer())
                                .contentType(MediaType.APPLICATION_JSON)
                                .content(objectMapper.writeValueAsString(locationDTO)))
                                .andExpect(status().isOk())
        ...
        void getConsumerLocation_ShouldReturnOk() throws Exception {
                ...
                mockMvc.perform(get("/api/v1/locations/consumers/me")
                                .with(authenticatedConsumer()))
                                .andExpect(status().isOk())
        ...
        void saveProviderLocation_ShouldReturnCreated() throws Exception {
                ...
                mockMvc.perform(post("/api/v1/locations/provider/me")
        ...
        void isConsumerWithinProviderServiceArea_ShouldReturnOk() throws Exception {
                when(locationService.getConsumerLocation(CONSUMER_ID)).thenReturn(locationDTO);
                when(locationService.isLocationWithinServiceArea(PROVIDER_ID, locationDTO.getLatitude(),
                                locationDTO.getLongitude()))
                                .thenReturn(true);

                mockMvc.perform(get("/api/v1/locations/provider/{id}/service-area/consumer/{cid}", PROVIDER_ID,
                                CONSUMER_ID))
                                .andExpect(status().isOk())
                                .andExpect(content().string("true"));
        }
